...
3. Раскройте раздел **Старт** и задайте начальное количество мальков, взрослой рыбы и капитал. В Hard-режиме также задайте количество хищников.
4. В разделе **Биология** настройте характеристики популяции и вместимость озера `K`.
